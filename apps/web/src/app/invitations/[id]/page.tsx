                        ...
                        <CardContent className="space-y-4">
                            <div className="flex bg-slate-50 rounded-lg p-4 gap-3 items-center">
                                ...
                                <div className="min-w-0 space-y-1">
                                    ...
                                    <div className="font-semibold block text-slate-900 truncate">something</div>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-semibold text-slate-900 truncate">Karar Al-Shanoon</div>
                                        <div className="text-xs font-medium text-slate-500 truncate">alkarar975@gmail.com</div>
                                    </div>
