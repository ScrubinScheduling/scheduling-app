        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-md text-muted-foreground">Employee</span>
              {isEditing ? (
                <Select
                  showSearch
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                <DatePicker value={date} format="YYYY-MM-DD" onChange={(d) => setDate(d)} />
              ) : (
                <span className="text-lg font-semibold">{formatLongDate(shift.startTime)}</span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-md text-muted-foreground">Time</span>
              {isEditing ? (
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-lg font-semibold">Saskatoon</span>
            </div>
          </div>
        </div>
