...
const ShiftCard = ({ shift, isSelected, onPress }: { shift: Shift, isSelected: boolean; onPress: () => void }) => (
    ...
    <View style={styles.background}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {dummyShifts.shifts.map((shift, idx) => (
          <ShiftCard key={idx} shift={shift} isSelected={selectedShift === shift} onPress={() => setSelectedShift(shift)}/>
        ))}
      </ScrollView>
      {selectedShift && (
